...
void sync_scene_objects(luxcore::Scene* scene, XSI::RendererContext & xsi_render_context, const RenderType render_type, std::set<ULONG> &xsi_objects_in_lux, const XSI::CTime &eval_time, const ULONG override_material = 0);
